...
import styles from "./personal-information-policy.module.css";
const PersonalInformationPolicy: FunctionComponent = () => {
  ...
  return (
    <>
      <div className={styles.personalInformationPolicy}>
          ...
          <div className={styles.div}>
            <div className={styles.title}>
              <div className={styles.div1}>
                <b className={styles.policy}>
                  <p className={styles.exhibition}>{`Personal information `}</p>
                  <p className={styles.exhibition}>handling policy</p>
                </b>
              </div>
            </div>
          </div>
        ...
        <div className={styles.contents}>
          <div className={styles.div2}>
            <div className={styles.policyContent}>개인정보취급방침</div>
          </div>
        </div>
