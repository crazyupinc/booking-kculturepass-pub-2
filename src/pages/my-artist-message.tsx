...
import styles from "./my-artist-message.module.css";
const MyArtistMessage: FunctionComponent = () => {
  ...
  return (
    <>
      <div className={styles.myArtistMessage}>
          ...
          <div className={styles.div1}>
            <div className={styles.title}>
              <div className={styles.kParent}>
                ...
                <div className={styles.aboutUs}>나의 아티스트</div>
              </div>
            </div>
            <div className={styles.menu}>
              <b className={styles.linkHome}>BLACKPINK</b>
            </div>
          </div>
        </div>
        ...
        <div className={styles.contents}>
          <div className={styles.div5}>
            <div className={styles.div6}>
              ...
              <b className={styles.id}>Janrubyjane</b>
              <div className={styles.time}>1시간</div>
            </div>
            <div className={styles.div7}>
              <div className={styles.message1}>
                <span className={styles.messageTxt}>
                  <p className={styles.exhibition}>Dear BLINKs,</p>
                  <p className={styles.exhibition}>
                    I hope this message finds you all in good health and high
                    spirits. It's Jenny, reaching out to you with a heart full
                    of love and gratitude. As a member of BLACKPINK, I wanted to
                    take a moment to express my sincerest appreciation for your
...
export default MyArtistMessage;
