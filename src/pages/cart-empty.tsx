...
const CartEmpty: FunctionComponent = () => {
  ...
  const onLandingEventPageButtonClick = useCallback(() => {
    navigate("/eventconcert");
  }, [navigate]);
      ...
      <div className={styles.cartEmpty}>
        ...
        <div className={styles.contents}>
          <div className={styles.contentSection}>
            <div className={styles.cartIsEmpty}>장바구니가 비었습니다</div>
          </div>
          <button
            className={styles.landingEventPageButton}
            onClick={onLandingEventPageButtonClick}
          >
            <div className={styles.gotoEventPage}>Event 화면으로 이동</div>
          </button>
        </div>
