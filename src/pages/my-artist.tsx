...
const MyArtist: FunctionComponent = () => {
  ...
  const onArtist1Click = useCallback(() => {
      ...
      <div className={styles.myArtist}>
        ...
        <div className={styles.contents}>
          <div className={styles.titleSection}>
            <b className={styles.myArtists}>나의 아티스트</b>
          </div>
          <div className={styles.artistsList}>
            <div className={styles.div1}>
              <div className={styles.artist1} onClick={onArtist1Click}>
                <img className={styles.imgIcon} alt="" src="/-1@2x.png" />
                <div className={styles.name}>
                  <div className={styles.name1}>BLACKPINK</div>
                </div>
              </div>
              <div className={styles.artist1}>
                ...
                />
                <div className={styles.name}>
                  <div className={styles.name1}>HENRY</div>
                </div>
              </div>
            </div>
            <div className={styles.div1}>
              <div className={styles.artist1}>
                ...
                />
                <div className={styles.name}>
                  <div className={styles.name1}>ONEUS</div>
                </div>
              </div>
              <div className={styles.artist1}>
                <img
                ...
                />
                <div className={styles.name}>
                  <div className={styles.name7}>KINGDOM</div>
                </div>
              </div>
            </div>
          </div>
