...
import styles from "./customer-service-notice.module.css";
const CustomerServiceNotice: FunctionComponent = () => {
  ...
  return (
    <>
      <div className={styles.customerServiceNotice}>
        ...
        <div className={styles.contents}>
            ...
            <div className={styles.list}>
              <div className={styles.row1}>
                <div className={styles.div2}>
                  <div className={styles.title1}>홈페이지 오픈!</div>
                  <div className={styles.dateWriter}>2023.06.02 | 관리자</div>
                </div>
          ...
          <div className={styles.pagenation}>
            <img
              ...
              alt=""
              src="/iconprevious.svg"
            />
            <div className={styles.page}>
              <div className={styles.div4}>1</div>
            </div>
            <img className={styles.iconNext} alt="" src="/iconnext.svg" />
          </div>
        </div>
